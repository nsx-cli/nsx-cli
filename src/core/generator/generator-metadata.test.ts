...
describe("generator metadata helpers", () => {
  ...
  it("deriva tipo a partir do caminho do arquivo", () => {
    ...
    expect(deriveGeneratorTypeFromFilePath("src/generators/user.generator.ts")).toBe("user");
    expect(deriveGeneratorTypeFromFilePath("src\\generators\\dto.GENERATOR.js")).toBe("dto");
